        ...
        <div class="content">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100" id="menu-nav">
                        <a href="{{ route('admin.dashboard.get') }}" id="menu-dashboard"
                            class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Quản lý</a>
                        <div class="nav-item dropdown">
                            <a href="{{ route('admin.category.list') }}" id="menu-category" class="nav-link"><i
